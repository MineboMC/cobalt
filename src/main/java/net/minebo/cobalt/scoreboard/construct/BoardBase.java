      ...
      try {
         ...
         if (Reflection.isRepackaged()) {
            VERSION_TYPE = VersionType.V1_17;
                 ...
                 || Reflection.nmsOptionalClass(null, "ServerScoreboard$Method").isPresent()) {
            VERSION_TYPE = VersionType.V1_13;
         } else if (Reflection.nmsOptionalClass(null, "IScoreboardCriteria$EnumScoreboardHealthDisplay").isPresent()
                 || Reflection.nmsOptionalClass(null, "ObjectiveCriteria$RenderType").isPresent()) {
         ...
         Class<?> entityPlayerClass = Reflection.nmsClass("server.level", "EntityPlayer", "ServerPlayer");
         Class<?> playerConnectionClass = Reflection.nmsClass("server.network", "PlayerConnection", "ServerGamePacketListenerImpl");
         Class<?> packetClass = Reflection.nmsClass("network.protocol", "Packet");
         Class<?> packetSbObjClass = Reflection.nmsClass(gameProtocolPackage, "PacketPlayOutScoreboardObjective", "ClientboundSetObjectivePacket");
         Class<?> packetSbDisplayObjClass = Reflection.nmsClass(gameProtocolPackage, "PacketPlayOutScoreboardDisplayObjective", "ClientboundSetDisplayObjectivePacket");
         ...
         Optional<Class<?>> displaySlotEnum = Reflection.nmsOptionalClass("world.scores", "DisplaySlot");
         CHAT_COMPONENT_CLASS = Reflection.nmsClass("network.chat", "IChatBaseComponent","Component");
         CHAT_FORMAT_ENUM = Reflection.nmsClass(null, "EnumChatFormat", "ChatFormatting");
         DISPLAY_SLOT_TYPE = displaySlotEnum.orElse(int.class);
         RESET_FORMATTING = Reflection.enumValueOf(CHAT_FORMAT_ENUM, "RESET", 21);
         SIDEBAR_DISPLAY_SLOT = displaySlotEnum.isPresent() ? Reflection.enumValueOf(DISPLAY_SLOT_TYPE, "SIDEBAR", 1) : 1;
         ...
         Optional<Class<?>> numberFormat = Reflection.nmsOptionalClass("network.chat.numbers", "NumberFormat");
         ...
         if (numberFormat.isPresent()) { // 1.20.3
            Class<?> blankFormatClass = Reflection.nmsClass("network.chat.numbers", "BlankFormat");
            Class<?> fixedFormatClass = Reflection.nmsClass("network.chat.numbers", "FixedFormat");
            Class<?> resetScoreClass = Reflection.nmsClass(gameProtocolPackage, "ClientboundResetScorePacket");
            ...
            Optional<MethodHandle> optionalScorePacket = Reflection.optionalConstructor(packetSbScoreClass, lookup, scoreTypeOptional);
            ...
            Class<?> enumSbAction = Reflection.nmsClass("server", "ScoreboardServer$Action", "ServerScoreboard$Method");
