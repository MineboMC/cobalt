# Cobalt
Like crack for minecraft plugins.

# Download
To setup Cobalt usage with maven, put the following in your pom.xml
...
Once these tasks have been taken care of, compilation via `mvn clean install` will result in `target/cobalt-1.0-DEV.jar` being created.
